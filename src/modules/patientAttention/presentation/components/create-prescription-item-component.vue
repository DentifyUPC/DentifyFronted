...
const handleCreate = async () => {
  ...
  try {
    console.log(`💊 Creating prescription item for prescription ID: ${props.prescriptionId}`, form.value);
    ...
    successMessage.value = '✓ Medicamento creado correctamente';
    console.log('✓ Prescription item created successfully');
